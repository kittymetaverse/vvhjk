    ...
    <div className="min-h-screen h-full w-full overflow-hidden flex flex-col items-center justify-center bg-brand-background ">
      ...
      <header className="min-w-full text-gray-800 py-14 px-4 md:px-0">
        <div className="flex items-center container mx-auto max-w-5xl justify-between h-full">
          {/* Logo */}
          <Link href="#" passHref>
            <a className="font-coiny text-xl md:text-3xl font-bold text-white">
              <span>
                Smo|
              </span>
              Snakes
          ...
          <nav aria-label="Contact Menu">
            <ul className="flex items-center text-white space-x-4 md:space-x-6">
              ...
              <li className="cursor-pointer">
                <a
                  href="https://twitter.com/SmolSnaakes"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg
        ...
        <div className="flex flex-col items-center justify-center h-full w-full px-2 md:px-10">
          <div className="z-1 md:max-w-3xl w-full  filter backdrop-blur-sm py-4 rounded-md px-2 md:px-10 flex flex-col items-center">
            <h3 className="text-sm text-red tracking-widest">
              {walletAddress
                ? walletAddress.slice(0, 8) + '...' + walletAddress.slice(-4)
                : ''}
            </h3>

            <div className="flex flex-col md:flex-row md:space-x-14 w-full mt-10 md:mt-10">
              <div className="relative w-full">
                <div className="font-coiny z-10 absolute top-2 left-2 opacity-80 filter backdrop-blur-lg text-base px-4 py-2 bg-black border border-brand-purple rounded-md flex items-center justify-center text-white font-semibold">
                  <p>
                    <span className="text-white">{totalMinted}</span> /{' '}
                    {maxSupply}
                  </p>
                </div>
              ...
              <div className="flex flex-col items-center w-full px-4 mt-16 md:mt-0">
                <div className="font-coiny flex items-center justify-between w-full">
                  ...
                  <p className="flex items-center justify-center flex-1 grow text-center font-bold text-brand-purple text-3xl md:text-4xl">
                    {mintAmount}
                  </p>
                ...
                <p className="text-sm text-purple-200 tracking-widest mt-3">
                ...
                {walletAddress ? (
                  <button
                    className={` ${
                      paused || isMinting
                        ...
                        : 'bg-gradient-to-br from-brand-purple to-brand-black shadow-lg hover:shadow-purple-400/50'
                  ...
                  <button
                    className="font-coiny mt-12 w-full bg-gradient-to-br from-brand-purple to-brand-black shadow-lg px-6 py-3 rounded-md text-2xl text-white hover:shadow-purple-400/50 mx-4 tracking-wide uppercase"
            ...
            {status && (
              <div
                className={`border ${
                  status.success ? 'border-green-500' : 'border-brand-purple-400 '
                } rounded-md text-start h-full px-4 py-4 w-full mx-auto mt-8 md:mt-3"`}
              >
            ...
            <div className="border-t border-gray-800 flex flex-col items-center mt-10 py-2 w-full">
              <h3 className="font-coiny text-2xl text-white  mt-1">
                Contract Address
              </h3>
              <a
